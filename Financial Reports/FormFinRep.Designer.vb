...
Partial Class FormFinRep
    ...
    Private Sub InitializeComponent()
        ...
        Me.OVERDUEDataGridViewTextBoxColumn.DefaultCellStyle = DataGridViewCellStyle15
